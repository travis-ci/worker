	...
	testAPITagTestCases = []struct {
	...
	}{
		{
			...
			E: [][][]string{
				...
				{
					{"group:dev", "language_go:true", "os:linux"},
					{"group:dev", "language_go:true"},
					{"language_go:true", "os:linux"},
					{"language_go:true"},
					{"group:dev"},
					{"os:linux"},
				},
				{
					{"dist:precise", "group:edge", "language_ruby:true", "os:linux"},
				...
				{
					{"language_python:true", "os:osx", "osx_image:xcode7"},
					{"language_python:true", "osx_image:xcode7"},
					{"language_python:true", "os:osx"},
					{"language_python:true"},
					{"osx_image:xcode7"},
					{"os:osx"},
				},
				{
					{"language_objective-c:true", "os:osx", "osx_image:xcode6.4"},
					{"language_objective-c:true", "osx_image:xcode6.4"},
					{"language_objective-c:true", "os:osx"},
					{"language_objective-c:true"},
					{"osx_image:xcode6.4"},
					{"os:osx"},
				},
				{
					{"dist:yosammity", "group:fancy", "language_node_js:true", "os:osx", "osx_image:xcode6.1"},
					{"language_node_js:true", "osx_image:xcode6.1"},
					{"dist:yosammity", "group:fancy", "language_node_js:true"},
					{"dist:yosammity", "language_node_js:true"},
					{"group:fancy", "language_node_js:true"},
					{"language_node_js:true", "os:osx"},
